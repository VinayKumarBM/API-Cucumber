...
For Demo purpose all the test cases are done on [reqres.in](https://reqres.in/) & [JSONPlaceholder](https://jsonplaceholder.typicode.com/).
...
**Report:** 	*target/cucumber/cucumber-html-report.html*
